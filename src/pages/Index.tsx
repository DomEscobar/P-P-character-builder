...
import { Activity, Lightbulb, Award, FileText, Shield, Sword, Package } from "lucide-react";
          ...
          <div className="relative">
            ...
            <div className="bg-[#f5e8c8] rounded-lg shadow-md p-4 border border-[#d8c38d]">
              <Tabs defaultValue="stats" className="w-full">
                <TabsList className="grid grid-cols-6 mb-4 md:mb-4 bg-[#f0ddb0] border border-[#d8c38d] p-1 rounded-md">
                  ...
                  <TabsTrigger value="equipment" className="text-[#6b592b] data-[state=active]:bg-[#e2cc9c] data-[state=active]:text-[#4e3c10]">
                ...
                <TabsContent value="equipment" className="space-y-4 md:space-y-4">
