  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        isMobile ? "h-8 py-1 text-sm" : "h-10 py-2 text-sm",
        className
      )}
      {...props}
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDown className={`${isMobile ? 'h-3 w-3' : 'h-4 w-4'} opacity-50`} />
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <SelectPrimitive.Label
      ref={ref}
      className={cn(
        isMobile ? "py-1 pl-6 pr-2 text-xs font-semibold" : "py-1.5 pl-8 pr-2 text-sm font-semibold",
        className
      )}
      {...props}
    />
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        isMobile ? "py-1 pl-6 pr-2 text-sm" : "py-1.5 pl-8 pr-2 text-sm",
        className
      )}
      {...props}
    >
